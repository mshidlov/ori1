...
import { TaskUserWhereInput } from "../../taskUser/base/TaskUserWhereInput";
...
export class UserControllerBase {
  ...
  async findManyTaskUsers(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<TaskUser[]> {
    const query: TaskUserWhereInput = request.query;
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findTaskUsers(params.id, {
      where: query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Delete("/:id/taskUsers")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async deleteTaskUsers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
